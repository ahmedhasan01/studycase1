...
## Procedure 
  ...
  9) Return via ladder: THROTTLE first → PASS only after stability.  
...
## Precedence Ladder (tighten-only) Order of enforcement for NEW ENTRIES (highest priority first): 
