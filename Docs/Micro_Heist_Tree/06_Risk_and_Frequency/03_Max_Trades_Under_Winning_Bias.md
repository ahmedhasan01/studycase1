...
- MUST "maximum valid trades" is always bounded by confirmations, risk caps, cooldowns, and robustness gates; never exceed these. If `entry_policy=BLOCK` or Shock/Dislocation override is active -> no new entries; exits/reductions allowed.
