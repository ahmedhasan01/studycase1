...
## 1.2 Rules (MUST/SHOULD/MAY)
    ...
    - SHOULD document trigger and change mapping (e.g., High-Vol Expansion and stricter confirmations and lower frequency; Low-Vol Compression and normal confirmations but throttled frequency).
...
## 1.3 Edge Cases / Conflicts
    ...
    - If a parameter lacks definition and treat as not READY; default to strictest; mark [INBOX-REVIEW].
