...
## 1.2 Rules (MUST/SHOULD/MAY)
    ...
    - MUST Define “confirmed flip” as: (a) persistence/stability of the new bias across required confirmations, AND (b) conflicts resolved (no active disagreement with readiness/health/edge gates). No numeric thresholds.
