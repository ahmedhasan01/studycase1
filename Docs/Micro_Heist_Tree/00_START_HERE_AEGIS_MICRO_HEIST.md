...
- 1.7A Conversation Protocol (Discussion → #RUN_PS)
...
- See: 1.7A / 1.7B (Conversation Protocol + Manual Execute Commands).
...
- STOP
- OPEN DISCUSSION (state what is missing and which fallback is needed)
