...
- [INBOX-REVIEW] **Bias module criteria:** exact persistence/stability + conflict-resolution rules that make a flip confirmed (controlling module not yet linked here).
### Precedence
